...
\ding{220} Vous proposerez une représentation graphique pour chacune des tâches qui vous semble pertinente.\\

\ding{220} Vous proposerez une analyse des résultats et des graphiques pour les deux tâches.
\vspace{0.5cm}
