...
@author: ceres
"""
## Ce script comporte toutes les fonctions 
import glob
import json
import re
import sklearn
...
def stocker_json(chemin,contenu):
    ...
    return
##Définir la langue à partir du chemin du fichier
def lang(chemin):
        dossiers = chemin.split("/")
        langue = dossiers [2]
        return langue
    
#créer le dictionnaire de langue
...
##Vectoriser et calculer une distance cosinus
