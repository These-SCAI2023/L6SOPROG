...
## Ce script comporte les fonctions dont on aura besoin
import json
import glob
import spacy
...
##Tokeniser avec un split()
def tokenisation_split(txt):
    tok=txt.split(" ")
    return tok

##Tokeniser avec un spaCy
...
#### Pour calcule et représenter une loi de zipf on reprend les fonctions du programme du semestre 5
...
## Transformer le doctionnaire en liste
...
##Afficher le vocabulaire et le rang des termes + avoir un apperçu tableau
...
##  Représenter les résultats graphiquement avec une loi de Zipf^
