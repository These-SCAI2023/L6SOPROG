...
Représenter graphiquement les clusters. Vous pouvez par exemple représenter les centroïdes avec des points plus ou moins gros selon que le cluster comprends plus ou moins de termes. Par exemple un centroïde dont le cluster comprends 10 tokens aura un point plus gros que celui d'un centroïde dont le cluster ne compte que 5 tokens.
