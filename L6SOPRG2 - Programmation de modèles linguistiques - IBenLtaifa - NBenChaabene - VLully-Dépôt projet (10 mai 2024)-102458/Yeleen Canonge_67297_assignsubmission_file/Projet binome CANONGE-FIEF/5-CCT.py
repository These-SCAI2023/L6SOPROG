...
# -*- coding: utf-8 -*-
"""
Created on Fri May 10 11:40:46 2024
...
chemin_entree = "donneesjsonT"  # Chemin d'entrée où se trouvent les fichiers JSON à traiter
...
for langue in ["en", "es", "fr"]:
    ...
    donnees_par_langue[langue] = {
        ...
        'trigrammes': clusters_mots,
        'trigramme_counts': clusters_nombre_mots,
        'total_trigramme_frequencies': clusters_frequence_totale
    }

# Chemin de sauvegarde du fichier JSON
chemin_sortie_json = "clusters_hierarchiqueT.json"
