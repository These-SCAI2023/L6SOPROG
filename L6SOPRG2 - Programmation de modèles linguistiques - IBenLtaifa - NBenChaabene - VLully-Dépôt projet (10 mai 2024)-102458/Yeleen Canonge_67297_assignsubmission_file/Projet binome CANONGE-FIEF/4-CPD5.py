...
def nettoyer_texte(texte, langue=None):
    ...
    C_grams_grams = [texte[i:i+5] for i in range(len(texte)-1)]
    return C_grams_grams


def process_files(folder_path, max_files_per_language=10):
    data = {}
...
if __name__ == "__main__":
    ...
    output_folder = os.path.join(folder_path, "donneesjson5")
