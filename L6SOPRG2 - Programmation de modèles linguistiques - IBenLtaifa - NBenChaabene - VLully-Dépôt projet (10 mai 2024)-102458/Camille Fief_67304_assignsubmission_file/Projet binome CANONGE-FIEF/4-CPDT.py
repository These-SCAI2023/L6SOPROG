...
# -*- coding: utf-8 -*-
"""
Created on Fri May 10 11:40:45 2024
...
def nettoyer_texte(texte, langue=None):
    ...
    tri_grams_grams = [texte[i:i+3] for i in range(len(texte)-1)]
    return tri_grams_grams
...
if __name__ == "__main__":
    ...
    output_folder = os.path.join(folder_path, "donneesjsonT")
