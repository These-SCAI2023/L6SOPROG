...
# -*- coding: utf-8 -*-
"""
Created on Fri May 10 11:40:50 2024
...
chemin_entree = "donneesjson5"  # Chemin d'entrée où se trouvent les fichiers JSON à traiter
...
for langue in ["en", "es", "fr"]:
    ...
    donnees_par_langue[langue] = {
        ...
        '5-grammes': clusters_mots,
        '5-gramme_counts': clusters_nombre_mots,
        'total_5-gramme_frequencies': clusters_frequence_totale
    }

# Chemin de sauvegarde du fichier JSON
chemin_sortie_json = "clusters_hierarchique5.json"
